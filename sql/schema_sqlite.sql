...
CREATE TABLE IF NOT EXISTS import_runs (
    ...
    only_votings INTEGER NOT NULL DEFAULT 0,
    only_sittings INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_import_run_logs_run_id ON import_run_logs (run_id);
...
CREATE TABLE IF NOT EXISTS voting_days (
